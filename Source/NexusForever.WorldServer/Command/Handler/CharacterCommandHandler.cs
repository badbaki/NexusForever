...
namespace NexusForever.WorldServer.Command.Handler
{
    ...
    public class CharacterCommandHandler : CommandCategory
    {
        ...
        [SubCommandHandler("properties", "[property] [amount] -- change a selection of character properties", Permission.PRCommands)] //set Properties - BAKI
            ...
            else
            {
                if (parameters[0].ToLower() == "speed")
                {
                    ...
                    if (result == true)
                    {
                        ...
                        {
                            context.Session.Player.SetBaseProperty(Property.MoveSpeedMultiplier, fValue);
                        }
                        else
                        {
                ...
                else if (parameters[0].ToLower() == "mountspeed")
                {
                    ...
                    if (result == true)
                    {
                        ...
                        {
                            context.Session.Player.SetBaseProperty(Property.MountSpeedMultiplier, fValue);
                        }
                        else
                        {
                ...
                else if (parameters[0].ToLower() == "gravity")
                {
                    ...
                    if (result == true)
                    {
                        ...
                        {
                            context.Session.Player.SetBaseProperty(Property.GravityMultiplier, fValue);
                        }
                        else
                        {
                ...
                else if (parameters[0].ToLower() == "jumpheight")
                {
                    ...
                    if (result == true)
                    {
                        ...
                        {
                            context.Session.Player.SetBaseProperty(Property.JumpHeight, fValue);
                        }
                        else
                        {
