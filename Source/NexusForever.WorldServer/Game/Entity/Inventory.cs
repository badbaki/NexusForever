...
namespace NexusForever.WorldServer.Game.Entity
{
    public class Inventory : IUpdate, IEnumerable<Bag>, ISaveCharacter
    {
        ...
        /// </summary>
        public void ItemCreate(uint itemId, uint count, byte reason = 49, uint charges = 1)
        {
            Item2Entry itemEntry = GameTableManager.Item.GetEntry(itemId);
            if (itemEntry == null)
                throw new ArgumentNullException();
        ...
        /// Create a new <see cref="Item"/> in the first available inventory bag index or stack.
        /// </summary>
        public void ItemCreate(Item2Entry itemEntry, uint count, byte reason = 49, uint charges = 1)
        {
            if (itemEntry == null)
                throw new ArgumentNullException();
